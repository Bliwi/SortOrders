...
$self_url = SORTORDERS_ADMIN.'-photo&amp;image_id='.$_GET['image_id'];
...
$template->set_filename('sortorders_content', realpath(SORTORDERS_PATH . 'admin/template/photo.tpl'));
